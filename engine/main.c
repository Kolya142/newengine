...
double deltaTime = 0, systemTime = 0;
...
NE_Vec2 NE_Vec2_From1(f64 x) {return (NE_Vec2){x,x};}
NE_Vec2 NE_Vec2_From2(f64 x, f64 y) {return (NE_Vec2){x,y};}

NE_Vec3 NE_Vec3_From1(f64 x) {return (NE_Vec3){x,x,x};}
NE_Vec3 NE_Vec3_From2(f64 x, f64 y) {return (NE_Vec3){x,y,0};}
NE_Vec3 NE_Vec3_From3(f64 x, f64 y, f64 z) {return (NE_Vec3){x,y,z};}

NE_Vec4 NE_Vec4_From1(f64 x) {return (NE_Vec4){x,x,x,x};}
NE_Vec4 NE_Vec4_From2(f64 x, f64 y) {return (NE_Vec4){x,y,0,0};}
NE_Vec4 NE_Vec4_From3(f64 x, f64 y, f64 z) {return (NE_Vec4){x,y,z,0};}
NE_Vec4 NE_Vec4_From4(f64 x, f64 y, f64 z, f64 w) {return (NE_Vec4){x,y,z,w};}
...
f64     NE_Vec3_MagSqrt(NE_Vec3 v) {return v.x*v.x+v.y*v.y+v.z*v.z;}
